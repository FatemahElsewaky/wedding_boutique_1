...
class EmployeeLoginPage:
    def __init__(self, master):
        ...
        self.entry_employee_id = tk.Entry(master, bg='white', fg='black', font=("Lucida Calligraphy", 20), highlightthickness=0)
        ...
        self.entry_username = tk.Entry(master, bg='white', fg='black', font=("Lucida Calligraphy", 20), highlightthickness=0)
        ...
        self.entry_password = tk.Entry(master, show="*", bg='white', fg='black', font=("Lucida Calligraphy", 20), highlightthickness=0)
...
class HomePage:
    def __init__(self, master):
        ...
        self.message_frame = tk.Frame(master, bg='#E4B1AB', pady=10, padx=20,bd=2, relief="solid", highlightbackground="black" )
        ...
        self.exit_button = tk.Button(master, text="Exit", command=master.quit, width=10, height=2,
                                     bg="#E4B1AB", fg="black", font=("Lucida Calligraphy", 36),
                                     bd=1.3, relief="solid", highlightbackground="black")
